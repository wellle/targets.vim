...
function! s:createPairTextObjects()
    for delimiters in s:pair_list " aliases like surround
        ...
        call s:createPairTextObject(s:I,       delimiters, 'grow seekselectp shrink')
        call s:createPairTextObject(s:A,       delimiters, 'grow seekselectp expand')
...
function! s:createTagTextObjects()
    ...
    call s:createSimpleTextObject(s:I,       't', 'grow seekselectt innert shrink')
    call s:createSimpleTextObject(s:A,       't', 'grow seekselectt expand')
